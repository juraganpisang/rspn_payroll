...
<div class="main-panel">
    ...
    <script>
        $(document).ready(function() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('Tunjangan_jabatan/save') ?>',
                cache: false,
                contentType: false,
                processData: false,
                data: dt,
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url('Tunjangan_jabatan/edit') ?>/' + b.data('id'),
                dataType: 'JSON',
                async: false,
                done: function(r) {},
                beforeSend: function() {
                ...
                success: function(r) {
                    ...
                    currencyFormat();
                    $('#form-data').find('#id').val(r.tj_id);
                    $('#form-data').find('#nama').val(r.tj_nama);
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('Tunjangan_jabatan/aktif') ?>/' + b.data('id'),
                        dataType: 'JSON',
                        // async: false,
                        done: function(r) {},
                        beforeSend: function() {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '<?= base_url('Tunjangan_jabatan/nonaktif') ?>/' + b.data('id'),
                        dataType: 'JSON',
                        // async: false,
                        done: function(r) {},
                        beforeSend: function() {
            ...
            e.preventDefault();
            window.open('<?php echo base_url('Tunjangan_jabatan/export_excel/') ?>', '_blank');
        });
