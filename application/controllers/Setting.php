...
class Setting extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->template->view('VSetting', $data);
    }
    ...
    private function list_()
    {
        ...
        $data = $this->MCore->list_data('payroll_setting');
        ...
        foreach ($data->result_array() as $value) {
            ...
            $button = '
            <button id="btn-edit" type="button" data-toggle="tooltip" data-kode="' . $value['set_kode'] . '" title="" class="btn btn-link btn-simple-primary btn-lg" data-original-title="Edit">
        <i class="fa fa-edit"></i></button>';

?>
            <tr class="mb-2">
                <td class="text-center"><?= $no ?></td>
                <td><?= $value['set_keterangan'] ?></td>
                <td><?= $value['set_value'] ?></td>
...
<?php
    ...
    {
        $data = $this->MCore->get_data('payroll_setting', 'set_kode = "' . $kode.'"');
    ...
    public function save()
    {
        ...
        $data = array(
            'set_value' => $this->input->post('value'),
            'set_keterangan' => $this->input->post('keterangan'),
        );


        // UPDATE
        $sql = $this->MCore->save_data('payroll_setting', $data, true, array('set_kode' => $kode));
    ...
    public function export_excel()
    {
        ...
        $listInfo = $this->MCore->list_data('payroll_setting')->result();
        ...
        foreach ($listInfo as $list) {
            ...
            $sheet->SetCellValue('B' . $rowCount, $list->set_keterangan);
            $sheet->SetCellValue('C' . $rowCount, $list->set_value);
        ...
        $sheet->getStyle("A5:C" . ($rowCount - 1))->applyFromArray($styleArray);
